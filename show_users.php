      ...
      <table class="table table-bordered table-striped table-hover text-center" id="myTable" style="width: 100%">
        <thead>
          <tr>
            ...
            <th scope="col" class="bg-dark text-light">Phone Number</th>
            <th scope="col" class="bg-dark text-light">Address</th>
            <th scope="col" class="bg-dark text-light">Register Time</th>
          </tr>
        </thead>
        <tbody>
        ...
        $sql = "SELECT `email_id`, `name`, `gender`, `phone_no`, `address`, `register_date` FROM `users_details`";
