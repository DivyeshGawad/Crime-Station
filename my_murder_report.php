      ...
      <table class="table table-bordered table-striped table-hover text-center" id="myTable" style="width: 100%">
        <thead>
          <tr>
            ...
            <th scope="col" class="bg-dark text-light">Murder Location</th>
        ...
        $sql = "SELECT `case_id`, `v_name`, `location`, `description`, `report_time` FROM `murder_complaint` WHERE `user_id` = '$user_id'";
