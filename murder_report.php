...
include "partials/db_connect.php";
  ...
  $sql = "INSERT INTO `murder_complaint` (`user_id`, `v_name`, `location`, `description`, `report_time`) VALUES ('$email', '$v_name', '$location', '$desc', current_timestamp())";
...
<div class="" style="margin-top: 2%"> 
  <div class="center-container">
     <div class="bg-agile">
      ...
      <form action="/Crime Station/Murder_report.php" method="POST">
        <div class="mb-3">
        ...
        <div class="mb-3">
          <label for="location" class="label-txt form-label">Enter Murder Location</label>
          <input type="text" class="form-control" name="location" id="location" placeholder="Location of Murder" aria-describedby="location">
        </div>
        <div class="mb-3">
          <label for="descrition" class="form-label">Enter Description of Murder</label>
