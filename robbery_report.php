...
$showAlert = false;
  ...
  $desc = $_POST['description'];
   ...
   $sql = "INSERT INTO `robbery_complaint` (`user_id`, `location`, `description`, `report_time`) VALUES ('$user_id', '$location', '$desc', current_timestamp())"; 
...
<div class="" style="margin-top: 2%"> 
  <div class="center-container">
     <div class="bg-agile">
      ...
      <form action="robbery_report.php" method="post">
        <div class="mb-3">
        ...
        <div class="mb-3">
          <label for="location" class="label-txt form-label">Enter Robbery Location</label>
          <input type="text" class="form-control" name="location" id="location" placeholder="Robbery Location" aria-describedby="location">
        </div>
        <div class="mb-3">
          <label for="description" class="form-label">Description</label>
          <textarea rows="2" cols="20" class="form-control" name="description" placeholder="Description of Robbery"></textarea>
        </div>
