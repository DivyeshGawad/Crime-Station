...
<html lang="en">
  <head>
    ...
    <title>My Robbery Reports</title>
      ...
      <table class="table table-bordered table-striped table-hover text-center" id="myTable" style="width: 100%">
        <thead>
          <tr>
            ...
            <th scope="col" class="bg-dark text-light">Robbery Location</th>
        ...
        $sql = "SELECT `case_id`, `location`, `description`, `report_time` FROM `robbery_complaint` WHERE `user_id` = '$user_id'";
