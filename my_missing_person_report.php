...
<html lang="en">
  <head>
    ...
    <title>My Missing Person Reports</title>
      ...
      <table class="table table-bordered table-striped table-hover text-center" id="myTable" style="width: 100%">
        <thead>
          <tr>
            ...
            <th scope="col" class="bg-dark text-light">Victim's Name</th>
            <th scope="col" class="bg-dark text-light">Victim's Age</th>
            <th scope="col" class="bg-dark text-light">Gender</th>
            <th scope="col" class="bg-dark text-light">Height (cm)</th>
            ...
            <th scope="col" class="bg-dark text-light">Victim's Image</th>
        ...
        $sql = "SELECT `case_id`, `v_name`, `v_age`, `v_gender`, `v_height`, `missing_location`, `missing_date`, `contact_info`, `image_name`, `report_time` FROM `missing_person_complaint` WHERE `user_id` = '$user_id'";
